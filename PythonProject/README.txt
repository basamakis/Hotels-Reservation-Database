...
1 - If you dont have Patras vpn and want to run the program run the database in the file MySqlProject locally and then open the queries.py file and change in each function 
